...
namespace Транспортная_логистика_ЛР2
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.dataGridView2[5, 0].Value = 220;
            this.dataGridView2[5, 1].Value = 180;
            this.dataGridView2[5, 2].Value = 100;
            this.dataGridView2[5, 3].Value = 100;
            this.dataGridView2[5, 4].Value = 600;

            this.dataGridView2[0, 4].Value = 100;
            this.dataGridView2[1, 4].Value = 110;
            this.dataGridView2[2, 4].Value = 70;
            this.dataGridView2[3, 4].Value = 200;
            this.dataGridView2[4, 4].Value = 120;
