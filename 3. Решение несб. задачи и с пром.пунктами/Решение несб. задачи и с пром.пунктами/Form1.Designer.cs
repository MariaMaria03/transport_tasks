namespace Решение_несб.задачи_и_с_пром.пунктами
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Перейти к решению траснпортной задачи с промежуточными пунктами";
            ...
            this.button2.Text = "Перейти к решению несбалансированной транспортной задачи";
            ...
            this.label1.Text = "Решение несбалансированной транспортной  задачи\r\nи задачи с промежуточными пункта" +
                "ми";
